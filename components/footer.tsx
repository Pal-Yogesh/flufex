...
const socialLinks = [
  { icon: Instagram, href: "https://www.instagram.com/flufex_connect/", label: "Instagram" },
  { icon: Linkedin, href: "https://www.linkedin.com/company/flufex-connect/", label: "LinkedIn" },
...
const footerLinks = [
  {
    title: "Services",
    links: ["Influencer Marketing", "Talent Management", "Content Production"],
  },
  {
    title: "Company",
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mt-12 overflow-hidden">
          <motion.div
            ...
            className="text-[8rem] md:text-[12rem] lg:text-[16rem] font-bold text-foreground whitespace-nowrap select-none"
          >
            FLUFEX
          </motion.div>
        </div>
